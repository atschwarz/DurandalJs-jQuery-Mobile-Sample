define(['utils/routines'], function(routines) {
	var ctor = function() {
		this.displayName = 'Using jQuery Mobile and DurandalJs together';
		...
		// Parse site with jquery mobile.
		this.attached = function(viewHtml) {
